...
export default function SettingsPage() {
  ...
  const [currentHost, setCurrentHost] = useState("");         // echte host
  ...
  useEffect(() => {
    ...
    const handleHost = (h: string) => {
      ...
      // Input alleen bij initial load synchroniseren,
      // niet elke keer overschrijven wanneer je aan het typen bent.
